...
if (reversed == null) { reversed = false; }
	...
	this.shape_4.setTransform(-30.4787,-79.2503,0.7913,0.7913);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#8B502A").s().p("AiqhYIFWBmIghBLg");
	this.shape_5.setTransform(39.8063,-27.3427,0.7913,0.7913);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#8B502A").s().p("Ai9CXIF7lkIk/Gbg");
	this.shape_6.setTransform(-26.7201,-18.0452,0.7913,0.7913);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#8B502A").s().p("AEMiSIAgBLIpXDag");
	this.shape_7.setTransform(29.6385,-59.8641,0.7913,0.7913);

	this.instance = new lib.Path();
	this.instance.setTransform(-0.5,-45.5,0.7914,0.7914,0,0,0,17.4,17.4);
	this.instance.alpha = 0.3516;
	this.instance.compositeOperation = "multiply";

	this.instance_1 = new lib.CompoundPath();
	this.instance_1.setTransform(-0.4,-45.5,0.7914,0.7914,0,0,0,35,34.9);
	this.instance_1.alpha = 0.3516;
	this.instance_1.compositeOperation = "multiply";

	this.instance_2 = new lib.CompoundPath_1();
	this.instance_2.setTransform(-0.45,-45.4,0.7914,0.7914,0,0,0,53.6,53.7);
	...
	this.shape_8.setTransform(0.3269,-44.6148,0.7914,0.7914);
	...
	this.shape_9.setTransform(-0.048,-44.9427,0.7913,0.7913);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regY:-31.8,rotation:8.9607,y:-12.2},24).to({regY:-31.9,rotation:0,y:-12.1},22).to({rotation:-8.2727,y:-12.15},22).to({rotation:0,y:-12.1},21).wait(1));

	// ear1
	this.instance_4 = new lib.Symbol2("synched",0);
	this.instance_4.setTransform(-23.8,-10.7,1,1.0703,0,0,0,4.2,-30.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:4,regY:-30.4,scaleY:1.0702,rotation:8.2836,x:-24},21).to({regX:4.2,regY:-30.5,scaleY:1.0703,rotation:0,x:-23.8},22).to({rotation:-4.7885,x:-23.75,y:-10.8},22).to({rotation:0,x:-23.8,y:-10.7},21).wait(4));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({startPosition:0},0).to({y:-189.45},5).to({y:-176.8},2).to({y:-181.2},1).to({y:-176.8},2).wait(65).to({startPosition:0},0).wait(1).to({y:-182.6781},0).wait(1).to({y:-187.25},0).wait(1).to({y:-101.0278},0).wait(1).to({y:-49.2944},0).wait(1).to({y:-32.05},0).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AorMCQibgihWgvIAAAAQhYgxgBg3IAAAAQAAhFCEg3IAAAAIAAgQIYVAAIAAAUQB5A2gBBCIAAAAIAAAAQAAAxhFAsIAAAAQhEAqh7AhIAAAAQh9AiikASIAAAAQiqATi6AAIAAAAQlFAAj5g2gAMkG9I4VAAImWAAIAAz0MAkPAAAIAAT0g");
